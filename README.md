## 技术栈：
react + react-router按需加载 + redux + immutable + less + sass + ES6 + webpack + fetch + webpack-dev-server反向代理 +react-transform热替换
...
七、11月14日新增热替换功能，局部替换修改的状态，不用刷新页面，提高开发效率。部分less文件改成sass文件，两种css预编译工具，感觉差别不大
```
